...
import com.destroystokyo.paper.profile.PlayerProfile; // Paper API
...
public class ItemManager {
    ...
    private static final String ENDER_CHEST_TEXTURE = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzYxZTViMjFiZjczNmIzZWI5YTI1OWU3MTc2. LagerManager.java
Der vollständige Code, um die Datei zu reparieren.

**Pfad:** `src/main/java/de/bierLager/plugin/LagerManager.java`
        ...
        for (LagerNode sourceNode : inputs) {
            ...
            for (int i = 0; i < sourceInv.getSize(); i++) {
                ...
                for (LagerNode targetNode : outputs) {
                    ...
                    if (targetNode.getFilterMaterials().isEmpty()) continue; 
